...
for train-only normalization to work), an additional --data ieee39 option, and a val split that
is loaded (proving it exists and is usable) but not yet used for checkpoint selection --
"best test MSE" remains the reported metric, matching the established protocol in this project.
'''
import os
import sys
